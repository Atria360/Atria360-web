...
const FIELDS: Field[] = [
  ...
  { key: "logo_url", label: "Logo — light backgrounds (header)", type: "image" },
  {
    key: "logo_url_dark",
    label: "Logo — dark backgrounds (footer)",
    type: "image",
    help: "White/reversed version. Falls back to the light logo if empty.",
  },
  {
    key: "favicon_url",
    label: "Favicon / touch icon",
    type: "image",
    help: "Icon mark only — square. The wide logo is unreadable at 16px.",
  },
